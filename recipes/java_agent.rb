...
raise 'You must specify either node[\'appdynamics\'][\'version\'] or node[\'appdynamics\'][\'dotnet_agent\'][\'version\']' unless version
...
directory "#{agent['install_dir']}/javaagent/logs" do
  owner agent['owner']
  group agent['group']
  mode '0755'
end
